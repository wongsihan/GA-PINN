...
if __name__ == '__main__':
    ...
    # 采样方式设置
    AM_type = 1  # 0:RAM  1:WAM  #2:None
    AM_K = 1
    AM_count = 20
    AW_lr = 0.001
    pic_name = "GAMGP-PINN-A3S150C5"
    model_name = "model_GAMGP-PINN-A3S150C5.pt"
    ...
    solution_copper_A2dx = \
        grad(solution_copper_A2, input_copper_A2_x, grad_outputs=torch.ones_like(solution_copper_A2),
             create_graph=True)[0]
    solution_copper_A2dy = \
        grad(solution_copper_A2, input_copper_A2_y, grad_outputs=torch.ones_like(solution_copper_A2),
             create_graph=True)[0]
    ...
    # if os.path.exists(r'C:\Users\Ethan\Desktop\AMAW-PINN-master\AMAW-PINN-master\2Dpossion_equation\save'):
    #     net = torch.load(
    #         r'C:\Users\Ethan\Desktop\AMAW-PINN-master\AMAW-PINN-master\2Dpossion_equation\save\model_tim_GAMGP-PINN.pt2024-01-08-11-07-47')
